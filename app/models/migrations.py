...
ADD_COLUMN_MIGRATIONS = [
    ...
    _add_column("0042_x_media_title", "x_media_assets", "title", "ALTER TABLE x_media_assets ADD COLUMN title TEXT"),
    _add_column("0043_x_media_author_name", "x_media_assets", "author_name", "ALTER TABLE x_media_assets ADD COLUMN author_name VARCHAR(255)"),
    _add_column("0044_x_media_published_at", "x_media_assets", "published_at", "ALTER TABLE x_media_assets ADD COLUMN published_at TIMESTAMP NULL"),
    _add_column("0045_x_media_cover_url", "x_media_assets", "cover_url", "ALTER TABLE x_media_assets ADD COLUMN cover_url TEXT"),
    _add_column("0046_x_media_duration", "x_media_assets", "duration_ms", "ALTER TABLE x_media_assets ADD COLUMN duration_ms INTEGER"),
    _add_column("0047_x_media_width", "x_media_assets", "width", "ALTER TABLE x_media_assets ADD COLUMN width INTEGER"),
    _add_column("0048_x_media_height", "x_media_assets", "height", "ALTER TABLE x_media_assets ADD COLUMN height INTEGER"),
    _add_column("0049_x_media_views", "x_media_assets", "view_count", "ALTER TABLE x_media_assets ADD COLUMN view_count BIGINT"),
    _add_column("0050_x_media_likes", "x_media_assets", "like_count", "ALTER TABLE x_media_assets ADD COLUMN like_count BIGINT"),
    _add_column("0051_x_media_comments", "x_media_assets", "comment_count", "ALTER TABLE x_media_assets ADD COLUMN comment_count BIGINT"),
    _add_column("0052_x_media_shares", "x_media_assets", "share_count", "ALTER TABLE x_media_assets ADD COLUMN share_count BIGINT"),
    _add_column("0053_platform_media_title", "platform_media_assets", "title", "ALTER TABLE platform_media_assets ADD COLUMN title TEXT"),
    _add_column("0054_platform_media_author_name", "platform_media_assets", "author_name", "ALTER TABLE platform_media_assets ADD COLUMN author_name VARCHAR(255)"),
    _add_column("0055_platform_media_published_at", "platform_media_assets", "published_at", "ALTER TABLE platform_media_assets ADD COLUMN published_at TIMESTAMP NULL"),
    _add_column("0056_platform_media_cover_url", "platform_media_assets", "cover_url", "ALTER TABLE platform_media_assets ADD COLUMN cover_url TEXT"),
    _add_column("0057_platform_media_duration", "platform_media_assets", "duration_ms", "ALTER TABLE platform_media_assets ADD COLUMN duration_ms INTEGER"),
    _add_column("0058_platform_media_width", "platform_media_assets", "width", "ALTER TABLE platform_media_assets ADD COLUMN width INTEGER"),
    _add_column("0059_platform_media_height", "platform_media_assets", "height", "ALTER TABLE platform_media_assets ADD COLUMN height INTEGER"),
    _add_column("0060_platform_media_views", "platform_media_assets", "view_count", "ALTER TABLE platform_media_assets ADD COLUMN view_count BIGINT"),
    _add_column("0061_platform_media_likes", "platform_media_assets", "like_count", "ALTER TABLE platform_media_assets ADD COLUMN like_count BIGINT"),
    _add_column("0062_platform_media_comments", "platform_media_assets", "comment_count", "ALTER TABLE platform_media_assets ADD COLUMN comment_count BIGINT"),
    _add_column("0063_platform_media_shares", "platform_media_assets", "share_count", "ALTER TABLE platform_media_assets ADD COLUMN share_count BIGINT"),
]
